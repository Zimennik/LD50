        ...
        if (useStamina)
        {
            ...
            if (isSprinting)
            {
                ...
                if (drawStaminaMeter)
                {
                    ...
                    StaminaMeter.color = Vector4.MoveTowards(StaminaMeter.color, new Vector4(0, 0.7f, 0, 1), 0.15f);
                }
            }
            ...
            if (drawStaminaMeter)
            {
                if (staminaInternal == staminaLevel)
                {
                    ...
                    StaminaMeter.color = Vector4.MoveTowards(StaminaMeter.color, new Vector4(0, 0.7f, 0, 0), 0.15f);
                }
...
/*     public IEnumerator FOVKickOut()
    ...
    float SlopeCheck()
    {
        ...
        return new AnimationCurve(new Keyframe(-90.0f, 1.0f), new Keyframe(0.0f, 1.0f),
                ...
                { preWrapMode = WrapMode.Clamp, postWrapMode = WrapMode.ClampForever }
